...
/**
 * Servlet implementation class domainWeigtManageServlet
 */
@WebServlet("/domainWeigtManageServlet")
public class domainWeigtManageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public domainWeigtManageServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
	        ...
	        String sqlStr = "select count(*) from userdomain where domainName like '%"+domainName+"%'";
	        ...
	        while(rs.next()){
	        	...
	        	domain.setCreateTime(sdf.format(rs.getDate("createTime")));
	        	domain.setTotalPage(totalPage);
	        	domain.setTotalRecord(totalRecord);
